...
class MMSBindings extends NativeResource {
  ...
  Future<List<MMSLanguageInfo>> getSupportedLanguages(String modelPath) async {
    ...
    _supportedLanguagesCache = [
      const MMSLanguageInfo(
          code: 'eng', name: 'English', nativeName: 'English', script: 'Latin'),
      const MMSLanguageInfo(
          code: 'spa', name: 'Spanish', nativeName: 'Español', script: 'Latin'),
      const MMSLanguageInfo(
          code: 'fra', name: 'French', nativeName: 'Français', script: 'Latin'),
      const MMSLanguageInfo(
          code: 'deu', name: 'German', nativeName: 'Deutsch', script: 'Latin'),
      const MMSLanguageInfo(
          code: 'ita',
          name: 'Italian',
          nativeName: 'Italiano',
      ...
      const MMSLanguageInfo(
          ...
          script: 'Cyrillic'),
      const MMSLanguageInfo(
          code: 'zho', name: 'Chinese', nativeName: '中文', script: 'Han'),
      const MMSLanguageInfo(
          code: 'jpn',
          name: 'Japanese',
          nativeName: '日本語',
          script: 'Kana/Kanji'),
      const MMSLanguageInfo(
          code: 'kor', name: 'Korean', nativeName: '한국어', script: 'Hangul'),
      const MMSLanguageInfo(
          code: 'ara', name: 'Arabic', nativeName: 'العربية', script: 'Arabic'),
      const MMSLanguageInfo(
          code: 'hin',
          name: 'Hindi',
          nativeName: 'हिन्दी',
          script: 'Devanagari'),
      const MMSLanguageInfo(
          code: 'ben', name: 'Bengali', nativeName: 'বাংলা', script: 'Bengali'),
      const MMSLanguageInfo(
          code: 'pan',
          name: 'Punjabi',
          nativeName: 'ਪੰਜਾਬੀ',
      ...
      const MMSLanguageInfo(
          ...
          script: 'Latin'),
      const MMSLanguageInfo(
          code: 'tel', name: 'Telugu', nativeName: 'తెలుగు', script: 'Telugu'),
      const MMSLanguageInfo(
          code: 'mar',
          name: 'Marathi',
          nativeName: 'मराठी',
          script: 'Devanagari'),
      const MMSLanguageInfo(
          code: 'tam', name: 'Tamil', nativeName: 'தமிழ்', script: 'Tamil'),
      const MMSLanguageInfo(
          code: 'urd', name: 'Urdu', nativeName: 'اردو', script: 'Arabic'),
      const MMSLanguageInfo(
          code: 'tur', name: 'Turkish', nativeName: 'Türkçe', script: 'Latin'),
    ];
