...
class ModelBundleCatalog {
  ...
  static const initialCandidates = <ModelBundleManifest>[
    ModelBundleManifest(
      ...
      reviewNotes:
          'Official NVIDIA VLM, commercially usable, not production selectable until checksum and RTX 5070 validation are recorded.',
    ...
    ModelBundleManifest(
      ...
      knownFailureModes: <String>[
        'Official artifact is large for a 12 GB GPU.',
        'May need KidsLens-owned NVFP4 or int4 conversion.',
        'Image-first model path needs chunk frame packing validation.',
      ],
      roles: <ModelBundleRole>[ModelBundleRole.vlm],
      approvalStatus: ModelBundleApprovalStatus.evaluationOnly,
      reviewNotes:
          'Official NVIDIA FP8 VLM candidate; requires RTX 5070 validation and checksum before production.',
      leaderboardSourcesReviewed: reviewedLeaderboardSources,
    ),
    ModelBundleManifest(
    ...
    ModelBundleManifest(
      ...
      knownFailureModes: <String>[
        ...
        'RTX 5070 fit is not proven.',
      ],
      roles: <ModelBundleRole>[ModelBundleRole.vlm],
      approvalStatus: ModelBundleApprovalStatus.evaluationOnly,
      reviewNotes:
          'Terms-gated Meta candidate; cannot be selected until legal and GPU validation complete.',
      leaderboardSourcesReviewed: reviewedLeaderboardSources,
    ),
    ModelBundleManifest(
      ...
      approvalStatus: ModelBundleApprovalStatus.watchlist,
      reviewNotes:
          'Official-derived R&D reference only until upstream terms and GPU fit are validated.',
      leaderboardSourcesReviewed: reviewedLeaderboardSources,
    ),
    ModelBundleManifest(
