...
- [x] **0.1 Create GitHub Actions workflow** `.github/workflows/ci.yml`, `windows-latest` (4c4b105):
  1. `flutter pub get`
...
- [x] **0.4 Verify agent tooling** (added with this plan): `CLAUDE.md` at repo root, `.claude/settings.json` hooks (generated-file guard + dart format), `.claude/skills/quality-gates/`, `.claude/skills/implement-next/`. Adjust hook commands if they misbehave on this machine. (current commit)
