...
- [x] **0.3 Repo hygiene**: delete `flutter.log`, `rebuild_vs2026.log`, empty dirs `native/sherpa_onnx/`, `native/vibevoice/`; add `*.log`, `coverage/` to `.gitignore`. Verify `build/` is ignored. (.gitignore + pubspec.lock commit, see body)
