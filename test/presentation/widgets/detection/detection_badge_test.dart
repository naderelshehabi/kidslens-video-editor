...
void main() {
  group('DetectionBadge', () {
    ...
    group('icons per type', () {
      ...
      testWidgets('nudity shows visibility_off icon', (tester) async {
        await tester.pumpWidget(
          createDetectionBadge(
            type: 'nudity',
            count: 1,
      ...
      testWidgets('unknown type shows error icon', (tester) async {
        await tester.pumpWidget(
          createDetectionBadge(
            type: 'unknown',
            count: 1,
    ...
    group('selection state', () {
      ...
      testWidgets('selected badge has solid background', (tester) async {
        await tester.pumpWidget(
          createDetectionBadge(
            type: 'profanity',
            count: 1,
      ...
      testWidgets('unselected badge has colored text', (tester) async {
        await tester.pumpWidget(
          createDetectionBadge(
            type: 'profanity',
            count: 1,
      ...
      testWidgets('selected badge has thicker border', (tester) async {
        await tester.pumpWidget(
          createDetectionBadge(
            type: 'profanity',
            count: 1,
      ...
      testWidgets('unselected badge has thinner border', (tester) async {
        await tester.pumpWidget(
          createDetectionBadge(
            type: 'profanity',
            count: 1,
    ...
    group('interaction', () {
      ...
      testWidgets('is tappable when onTap is null', (tester) async {
        await tester.pumpWidget(
          createDetectionBadge(
            type: 'profanity',
            count: 1,
    ...
    group('count display', () {
      ...
      testWidgets('count is in container with rounded corners', (tester) async {
        await tester.pumpWidget(
          createDetectionBadge(
            type: 'profanity',
            count: 5,
