  ...
  group('LoadingOverlay', () {
    ...
    testWidgets('shows dark overlay when loading', (tester) async {
      ...
      final coloredBox = find.byWidgetPredicate(
        (widget) => widget is ColoredBox && widget.color == Colors.black54,
      );
    ...
    testWidgets('progress value of 1 shows 100.0%', (tester) async {
      await tester.pumpWidget(
        createLoadingOverlay(
          isLoading: true,
          child: const Text('Child Content'),
    ...
    testWidgets('message and progress can be shown together', (tester) async {
      await tester.pumpWidget(
        createLoadingOverlay(
          isLoading: true,
          child: const Text('Child Content'),
    ...
    testWidgets('child remains accessible when not loading', (tester) async {
